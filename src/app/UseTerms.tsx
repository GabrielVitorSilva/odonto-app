...
export default function UseTermsScreen() {
  ...
  return (
    <View className="flex-1 bg-white pt-10">
      <Text className="text-4xl font-roboto-bold text-center mb-8">Termos de Uso</Text>

      <ScrollView className="px-4">
        <View className="space-y-4">
          <Text className="text-lg font-roboto-bold">1. Aceitação dos Termos</Text>
          ...
          <Text className="text-lg font-roboto-bold">2. Agendamentos</Text>
          <Text className="text-base text-gray-700 font-roboto">
          ...
          <Text className="text-lg font-roboto-bold">3. Cancelamentos e Remarcações</Text>
          <Text className="text-base text-gray-700 font-roboto">
          ...
          <Text className="text-lg font-roboto-bold">4. Privacidade e Dados Médicos</Text>
          <Text className="text-base text-gray-700 font-roboto">
          ...
          <Text className="text-lg font-roboto-bold">5. Responsabilidades</Text>
          <Text className="text-base text-gray-700 font-roboto">
          ...
          <Text className="text-lg font-roboto-bold">6. Modificações</Text>
          <Text className="text-base text-gray-700 font-roboto">
          ...
          <Text className="text-lg font-roboto-bold">7. Contato</Text>
          <Text className="text-base text-gray-700 font-roboto">
      ...
      <View className="p-4">
        ...
        >
          <Text className="text-white text-center font-roboto-bold">Confirmar</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
